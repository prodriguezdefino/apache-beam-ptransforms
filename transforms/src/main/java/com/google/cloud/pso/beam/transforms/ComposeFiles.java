...
public class ComposeFiles<KeyT, DataT>
  ...
  /**
   * Given a compose context object, if configured to, will delete all the original part files of
   * the compose object.
   */
  ...
  /**
   * Given a compose context object, will move the temporary compose file to its final configured
   * destination.
   */
  ...
  /**
   * Given a compose context object will grab all the part files, extract the object names and
   * create a compose object in a temporary location.
   */
